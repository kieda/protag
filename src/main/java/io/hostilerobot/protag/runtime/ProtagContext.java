package io.hostilerobot.protag.runtime;
 ...
 */
public class ProtagContext {
    YaNamePath currentPath;
    TrieMap<YaNamePath, YaData<? extends Object>> definitions;
    public ProtagContext() {
        definitions = new TrieMap<>();
    }
    public ProtagContext(YaNamePath.PathItem scope, ProtagContext other) {
