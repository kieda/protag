...
public class ProtagParser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short _production_table[][] = 
    ...
    "\000\025\000\002\002\004\000\002\005\003\000\002\005" +
    "\002\000\002\004\004\000\002\004\003\000\002\006\003" +
    "\000\002\006\003\000\002\006\003\000\002\010\003\000" +
    "\002\010\003\000\002\002\005\000\002\002\003\000\002" +
    "\003\005\000\002\003\003\000\002\013\005\000\002\012" +
    "\003\000\002\012\003\000\002\007\003\000\002\011\004" +
    "\000\002\011\004\000\002\011\002" });
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\032\000\016\002\uffff\005\013\006\004\007\020\010" +
    "\006\011\016\001\002\000\010\007\ufff1\010\ufff1\011\ufff1" +
    ...
    "\002\034\001\002\000\016\002\ufff0\005\ufff0\006\ufff0\007" +
    "\ufff0\010\ufff0\011\ufff0\001\002\000\004\002\000\001\002" +
    "\000\010\007\ufff2\010\ufff2\011\ufff2\001\002\000\016\002" +
    "\ufffd\005\013\006\004\007\020\010\006\011\016\001\002" +
    "\000\016\002\ufff8\005\ufff8\006\ufff8\007\ufff8\010\ufff8\011" +
    "\ufff8\001\002\000\020\002\ufff6\004\027\005\ufff6\006\ufff6" +
    "\007\ufff6\010\ufff6\011\ufff6\001\002\000\016\002\ufffc\005" +
    "\ufffc\006\ufffc\007\ufffc\010\ufffc\011\ufffc\001\002\000\016" +
    "\002\ufffb\005\ufffb\006\ufffb\007\ufffb\010\ufffb\011\ufffb\001" +
    "\002\000\010\007\022\010\023\011\uffed\001\002\000\010" +
    "\007\022\010\023\011\uffed\001\002\000\010\007\022\010" +
    "\023\011\uffed\001\002\000\004\011\026\001\002\000\016" +
    "\002\ufff5\005\ufff5\006\ufff5\007\ufff5\010\ufff5\011\ufff5\001" +
    "\002\000\020\002\ufff7\004\027\005\ufff7\006\ufff7\007\ufff7" +
    "\010\ufff7\011\ufff7\001\002\000\004\011\030\001\002\000" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\032\000\024\002\014\003\004\004\011\005\007\006" +
    "\013\007\016\010\010\012\020\013\006\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\002\001\001\000\002\001\001\000\002\001\001" +
    "\000\002\001\001\000\022\002\014\003\004\004\032\006" +
    "\013\007\016\010\010\012\020\013\006\001\001\000\002" +
    "\001\001\000\002\001\001\000\002\001\001\000\002\001" +
    "\001\000\004\011\023\001\001\000\004\011\031\001\001" +
    "\000\004\011\030\001\001\000\004\013\024\001\001\000" +
    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$ProtagParser$act_num)
		...
		IProtagSequence val = (IProtagSequence)((java_cup.runtime.Symbol) CUP$ProtagParser$stack.peek()).value;
		 RESULT = val; 
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("program",3, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;
        ...
        RESULT = null;
              ...
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("program",3, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;
        ...
        if(i == null) {
            ...
            RESULT = rest;
              ...
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("protag",2, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.elementAt(CUP$ProtagParser$top-1)), ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;
        ...
        if(item == null) {
            ...
            RESULT.getItems().addFirst(item);
              ...
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("protag",2, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;
		...
		RESULT = data;
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("_item",4, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;

          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // _item ::= COMMENT 
            {
              ProtagNode RESULT =null;
		RESULT = null;
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("_item",4, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
        ...
        RESULT = real;
              ...
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("_baseData",6, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;
		...
		Integer decimalPart = (Integer)((java_cup.runtime.Symbol) CUP$ProtagParser$stack.peek()).value;
		 RESULT = new XDecimal(integerPart, decimalPart); 
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("_decimal",9, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.elementAt(CUP$ProtagParser$top-2)), ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;
		 ...
		 RESULT = ESignType.PLUS; 
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("_sign",8, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;
		...
		ProtagNode base = (ProtagNode)((java_cup.runtime.Symbol) CUP$ProtagParser$stack.peek()).value;
		 RESULT = base; 
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("_unboundedData",5, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;
          ...
          case 18: // spacing ::= WHITESPACE spacing 
            {
              ...
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("spacing",7, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.elementAt(CUP$ProtagParser$top-1)), ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;
          ...
          case 20: // spacing ::= 
            {
              ...
              CUP$ProtagParser$result = parser.getSymbolFactory().newSymbol("spacing",7, ((java_cup.runtime.Symbol)CUP$ProtagParser$stack.peek()), RESULT);
            }
          return CUP$ProtagParser$result;
